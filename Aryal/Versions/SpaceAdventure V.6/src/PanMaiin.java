...
public class PanMaiin extends JPanel implements ActionListener {
    ...
    private static final int nUpdateSpace = 50, nUpdateAste = 500; // milliseconds
    ...
    public void paint(Graphics g) {
        ...
        if (bShow) {
            ...
            g2d.setColor(Color.cyan);
            g2d.drawString("Time Survived: " + nDispTime +"s", 450, 10);
        } else {
        ...
        for (int i = 0; i < arlAste.size(); i++) {
            ...
            if (rctCraft.intersects(rctAste)) {
                ...
                if ((timerAste.getDelay() - 100) > 0) {
                    timerAste.setDelay(timerAste.getDelay() - 50);
                }
            }
