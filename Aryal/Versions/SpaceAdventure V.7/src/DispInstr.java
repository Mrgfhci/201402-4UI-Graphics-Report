...
public class DispInstr extends JPanel {
    ...
    public void paint(Graphics g) {
        ...
        g2d.setFont(myFont);
            g2d.drawString("Instructions:", 200, 110);
            g2d.drawString("Use the arrow keys to navigate the spaceship", 200, 150);
            g2d.drawString("The goal is to dodge the asteroids and survive for a long time", 200, 180);
        }
}
