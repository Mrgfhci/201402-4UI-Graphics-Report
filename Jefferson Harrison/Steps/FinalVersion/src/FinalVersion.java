...
//This calculator does not follow BEDMAS

import java.awt.*;
import java.awt.event.*;
import javax.swing.*;

public class FinalVersion extends JFrame {
 
    public static String sButtonPressed = "";//string version of button last pressed (uses .getActionCommand)
    public static String sWorkingNum = "";//string value of last number input by user
    public static String sOperation = "";//the operation to perform:  + , - , * , /
    public static double dWorkingNum1 = 0;//last number to have been input by user
    public static double dWorkingNum2 = 0;//working answer
    
    public static boolean bMultiNums = false;//Have there been multiple numbers entered by the user?
   ...
   public FinalVersion() {
       ...
       class Nums implements ActionListener {
           ...
           public void actionPerformed(ActionEvent event) {
               ...
               sWorkingNum += sButtonPressed;
               dWorkingNum1 = Double.parseDouble(sWorkingNum);
       ...
       class Calc implements ActionListener {
           ...
           public void actionPerformed(ActionEvent event) {
               ...
               sOperation = event.getActionCommand();
               tfMain.setText(tfMain.getText() + " " + sOperation + " ");
           }
       }
       ...
       class Equals implements ActionListener {
           ...
           public void actionPerformed(ActionEvent event) {
               ...
               tfMain.setText(tfMain.getText() + " = " + dWorkingNum2);
           }
       }
      ...
      setTitle("Calculator");  //window title
   ...
   public static void main(String[] args) {
      SwingUtilities.invokeLater(new Runnable() {
         @Override //adding this line fixes warning
         public void run() {
            new FinalVersion();  // call "FinalVersion" class
         }
      });
   }
}