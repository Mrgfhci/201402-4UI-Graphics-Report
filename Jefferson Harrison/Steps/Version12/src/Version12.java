...
public class Version12 extends JFrame {
    ...
    public static boolean bMultiNums = false;//Have there been multiple number entered by the user?
   ...
   public Version12() {
       ...
       class Nums implements ActionListener {
           ...
           public void actionPerformed(ActionEvent event) {
               ...
               sWorkingNum1 += sButtonPressed;
               dWorkingNum1 = Double.parseDouble(sWorkingNum1);
      ...
      setTitle("Calc - Version12");  //window title
   ...
   public static void main(String[] args) {
      SwingUtilities.invokeLater(new Runnable() {
         @Override //adding this line fixes warning
         public void run() {
            new Version12();  // call "Version12" class
         }
      });
   }
}